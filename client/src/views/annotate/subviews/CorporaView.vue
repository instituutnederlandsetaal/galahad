<template>
    <div>
        <!-- Owner corpus table -->
        <CorpusTable
            :type="TableCorporaType.User"
            :corpora="corporaStore.allCorpora"
            @delete="(corpus) => (deleteCorpusData = corpus)"
            @update="(corpus) => editMode(corpus)"
            selectable
        ...
        <!-- Shared corpus table -->
        <CorpusTable
            :type="TableCorporaType.Shared"
            :corpora="corporaStore.sharedCorpora"
            @delete="(corpus) => (deleteCorpusData = corpus)"
            @update="(corpus) => editMode(corpus)"
            selectable
        >
        ...
        <CorpusTable
            :type="TableCorporaType.Dataset"
            :corpora="corporaStore.datasetCorpora"
            @update="(corpus) => editMode(corpus)"
            selectable
        >
            <template #help>
        ...
        <CorpusForm
            ...
            :show="showNewCorpusModal"
            @hide="showNewCorpusModal = false"
            :action="
                (metadata) => {
        ...
        <!-- Update modal -->
        <CorpusForm
            title="Update corpus metadata"
            :show="updateCorpusData !== null"
            @hide="updateCorpusData = null"
            update
            :item="updateCorpusData"
            :action="
                (metadata) => {
        ...
        <!-- Delete modal -->
        <DeleteModal
            :show="deleteCorpusData !== null"
            :item="deleteCorpusData"
            :displayname="'Corpus ' + (deleteCorpusData !== null ? deleteCorpusData.name : '[null]')"
            @delete="corporaStore.deleteCorpus"
            @hide="deleteCorpusData = null"
        />
    </div>
</template>

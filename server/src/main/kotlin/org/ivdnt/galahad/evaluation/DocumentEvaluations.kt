...
class DocumentEvaluations(dir: File, private val corpus: Corpus, val jobs: JobPair) :
    GalahadFolderManager<DocumentEvaluation, String>(dir) {
    override fun ctor(key: String): DocumentEvaluation =
        DocumentEvaluation(dir.resolve(key), corpus, jobs)
